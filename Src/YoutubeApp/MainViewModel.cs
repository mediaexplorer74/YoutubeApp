    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        public MainViewModel()
        {
            ...
            using (Client<YouTubeVideo> service = Client.For(YouTube.Default))
            {
                ...
                string source_uri = "https://download.blender.org/peach/bigbuckbunny_movies/BigBuckBunny_320x180.mp4";
            MediaSource = VLC.MediaSource.CreateFromUri(source_uri
        ...
        private async void OpenSubtitleFileAsync()
        {
            ...
            if (file != null)
            {
                MediaSource.ExternalTimedTextSources.Add(
                    TimedTextSource.CreateFromUri($"winrt://{SUBTITLE_FILE_TOKEN}"));
            }
        }
