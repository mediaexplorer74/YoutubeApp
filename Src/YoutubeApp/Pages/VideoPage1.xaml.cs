...
namespace YTApp.Pages
{
    ...
    public sealed partial class VideoPage1 : Page
    {
        ...
        private async void VideoPlayer_MediaEnded(object sender, RoutedEventArgs e)
        {
            ...
            {
                Debug.WriteLine("[ex] VideoPlayer_MediaEnded bug: " + ex.Message);
            }
        }
        #endregion
        ...
        {
            //Enter compact mode
            ViewModePreferences compactOptions = ViewModePreferences.CreateDefault(
            ...
            await ApplicationView.GetForCurrentView().TryEnterViewModeAsync(
                ApplicationViewMode.CompactOverlay, compactOptions);
