...
namespace Google.Apis.YouTube.v3
{
  public class SuperChatEventsResource
  {
    ...
    public SuperChatEventsResource(IClientService service) => this.service = service;

    public virtual SuperChatEventsResource.ListRequest List(string part) => new SuperChatEventsResource.ListRequest(this.service, part);
    ...
    public class ListRequest : YouTubeBaseServiceRequest<SuperChatEventListResponse>
    {
      ...
      public override string RestPath => "superChatEvents";
