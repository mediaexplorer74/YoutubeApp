...
// Type: Google.Apis.YouTube.v3.Data.SubscriptionListResponse
...
{
  public class SubscriptionListResponse : IDirectResponseSchema
  {
    [JsonProperty("etag")]
    ...
    [JsonProperty("items")]
    public virtual IList<Subscription> Items { get; set; }
