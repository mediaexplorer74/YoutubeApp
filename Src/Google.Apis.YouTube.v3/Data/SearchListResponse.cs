...
// Type: Google.Apis.YouTube.v3.Data.SearchListResponse
...
{
  public class SearchListResponse : IDirectResponseSchema
  {
    [JsonProperty("etag")]
    ...
    [JsonProperty("items")]
    public virtual IList<SearchResult> Items { get; set; }
