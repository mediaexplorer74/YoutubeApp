...
// Type: Google.Apis.YouTube.v3.Data.LiveStreamListResponse
...
{
  public class LiveStreamListResponse : IDirectResponseSchema
  {
    [JsonProperty("etag")]
    ...
    [JsonProperty("items")]
    public virtual IList<LiveStream> Items { get; set; }
