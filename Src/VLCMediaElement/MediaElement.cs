...
namespace VLC
{
    ...
    class MediaElement : Control
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            swapChainPanel.SizeChanged += async (sender, e) =>
            {
                //RnD
        ...
        private async void OnShowLoginDialogAsync(Dialog dialog, string title, string text,
            string defaultUserName, bool askToStore)
        {
